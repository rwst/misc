...
class CFiniteSequence(FractionFieldElement):
    ...
    EXAMPLES::
        ...
        if isinstance(ogf, Integer):
            ...
            self._a = ogf.list()
            """
        elif is_FractionFieldElement(ogf) or isinstance(ogf, sage.rings.fraction_field_FpT.FpTElement):
            num = ogf.numerator()
            den = ogf.denominator()
            ...
            R = LaurentSeriesRing(Rationals(), 'x')
            ...
            raise ValueError("Cannot convert a " + str(typ(ogf)) + " to CFiniteSequence.")

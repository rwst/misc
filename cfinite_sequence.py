...
class CFiniteSequence(FractionFieldElement):
    ...
    TESTS:
        ...
        if isinstance (ogf, FractionFieldElement):
            ...
            if self._off >= 0:
                super(CFiniteSequence, self).__init__(P.fraction_field(), x**self._off * num, den, *args, **kwargs)
            else:
                super(CFiniteSequence, self).__init__(P.fraction_field(), num, x**(-self._off) * den, *args, **kwargs)
